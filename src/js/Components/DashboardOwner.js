        ...
        <>
                ...
                <Navbar collapseOnSelect expand="lg"  style={{ background: '#0B0B45' }} >
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav" >
                        ...
                        <Nav className="m-3 ">
                            <NavLink className=" text-white"  to="/DashboardOwner"> <label> Home </label></NavLink>  
                        </Nav>
                        
                        
                       
                        <Nav className="m-3 " >
                                 <NavDropdown  className="text-light" style={{}} title="Item Detail" id="collasible-nav-dropdown">
                                 <NavDropdown.Item >
                                    <NavLink className="text-dark" to="/Product"><label>Add Item </label></NavLink>
                                </NavDropdown.Item>
                                <NavDropdown.Item >
                                    <NavLink  className=" text-dark" to="/ProductReport"><label> Manage Item </label></NavLink>
                                </NavDropdown.Item >
